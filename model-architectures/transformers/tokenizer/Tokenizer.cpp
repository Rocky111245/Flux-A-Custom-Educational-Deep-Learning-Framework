...
/*
 ...
 This is because,in a previous test, the time complexity was so high that respectable binary-serializer size was taking too long
 to tokenize.
...
//main driver code. Please call file path as (Load file std::ifstream file("../Transformer_Architecture/test-binary-serializer/test_for_tokenizer.txt");
