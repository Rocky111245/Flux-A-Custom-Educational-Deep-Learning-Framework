...
// Neural_Block: Orchestrates a stack of dense layers + loss.
//
// Purpose
// -------
...
#include "Loss_Functions/Tensor_Loss_Functions.h"


class Neural_Block {
public:
   explicit Neural_Block(Tensor residual_stream_input, std::initializer_list<Neural> layer_list,std::initializer_list<Tensor_Loss_Function> loss_function_list={});
